    ...
    public void updateFundamentalData(LocalDateTime ingameDate) {
        try{
            if(isPubliclyTraded){
                ...
                FinancialData financialData3 = new FinancialData(newRevenue,newCost,newGrossProfit,newCash,newLiabilities,newEquity,newAssets);
                ...
                fundamentalsSpace.put(this.companyTicker, ingameDate.getYear(),"Finance Statement",financialData3);
